...
})({"2LnoZ":[function(require,module,exports,__globalThis) {
...
},{}],"4pp4s":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _apiServiceJs = require("../js/apiService.js");
...
async function onSearch(event) {
    ...
    (0, _apiServiceJsDefault.default).query = event.currentTarget.elements.query.value.trim();
    if (!(0, _apiServiceJsDefault.default).query) return;
    (0, _apiServiceJsDefault.default).resetPage();
    clearGallery();
    await fetchAndRenderImages();
}
async function onLoadMore(entries) {
    for (const entry of entries)if (entry.isIntersecting && (0, _apiServiceJsDefault.default).query) await fetchAndRenderImages();
}
async function fetchAndRenderImages() {
    try {
        const data = await (0, _apiServiceJsDefault.default).fetchImages();
        if (!data.hits.length) throw new Error("No images found");
        renderGallery(data.hits);
        (0, _apiServiceJsDefault.default).incrementPage();
    } catch (error) {
...
window.addEventListener("scroll", ()=>{
    ...
    if (scrollTop + clientHeight >= scrollHeight - 200) fetchAndRenderImages();
});

},{"../js/apiService.js":"76e9R","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"76e9R":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}]},["2LnoZ","4pp4s"], "4pp4s", "parcelRequire94c2")
